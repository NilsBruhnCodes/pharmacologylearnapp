Map<int, String> chapterChoiceActiveIngredients = {
  ...
  1: 'VNS Sympathikus',
  2: 'Blutgefäße',
  3: 'Allgemeinanästhetika',
  4: 'Analgetika',
  5: 'Hypnotica & Anxiolytika',
  6: 'Asthma',
  7: 'Schilddrüse',
  8: 'Sexual Pharmaka',
  9: 'Glucocorticoide',
...
Map<String, String> getMap(String nameOfMap) {
  switch (nameOfMap) {
    ...
    case 'Virostatika':
      return virostatika;
    case 'Alk. & Nik.':
      return alkoholUndNikotin;
    case 'Epilepsie':
      return epilepsie;
    case 'Antidepressiva':
      return antidepressiva;
    case 'Neuroleptika':
      return neuroleptika;
    case 'Parkinson':
      return parkinson;
...
Map<String, String> parkinson = {
  'L-Dopa?':
      ' \n→ Wirkstoffklasse: Dopaminerger \n→ Wirkmechanismus: L-Dopa ist ein Vorläufer von Dopamin, einem wichtigen Neurotransmitter im Gehirn, der für die motorische Kontrolle und Bewegungskoordination verantwortlich ist. Bei Morbus Parkinson fehlt es an Dopamin im Gehirn, wodurch es zu motorischen Störungen kommt. L-Dopa wird zu Dopamin im Gehirn umgewandelt und ersetzt somit das fehlende Dopamin, was zu einer Verbesserung der motorischen Symptome führt. Nach einigen Jahren (3-7 Jahre) kommt es zur Wirkungseinschränkung und Wirkungsfluktuationen (on off Phänomen) \n→ Indikation: Morbus Parkinson \n→ Interaktionen: Neuroleptika, Metoclopramid \n→ Nebenwirkungen: Übelkeit, Erbrechen, Durchfall, Schläfrigkeit, Bauchschmerzen, Halluzinationen, psychotische Symptome \n→ Kontraindikation: Vorbestehende Psychose, Niereninsuffizienz, unkontrollierte Herz-Kreislauf-Erkrankungen',
  'Benserazid/Carbidopa?':
      ' \n→ Wirkstoffklasse: peripherer Decarboxylasehemmer \n→ Wirkmechanismus: Benserazid ist ein Peripher-Dopaminerger, d.h. es unterstützt die Wirkung von L-Dopa und verhindert, dass L-Dopa zu schnell metabolisiert wird. Dadurch bleibt mehr von L-Dopa erhalten, das zu Dopamin im Gehirn umgewandelt werden kann. Die Kombination von L-Dopa mit Benserazid kann die Wirksamkeit von L-Dopa bei Morbus Parkinson verbessern und die Dosis von L-Dopa reduzieren. \n→ Indikation: Morbus Parkinson \n→ Nebenwirkungen: Übelkeit, Erbrechen, Durchfall, Schläfrigkeit, Bauchschmerzen, Kopfschmerzen, Hitzewallungen \n→ Kontraindikation: Vorbestehende Niereninsuffizienz, unkontrollierte Herz-Kreislauf-Erkrankungen',
  'Entacapon/Tolcapone/Opicapone?':
      ' \n→ Wirkstoffklasse: Catechol-O-Methyltransferase (COMT) - Inhibitor \n→ Wirkmechanismus: der Wirkstoff ist ein Inhibitor von Catechol-O-Methyltransferase (COMT), einem Enzym, das an der Abbau von Dopamin beteiligt ist. Durch die Hemmung von COMT wird die Wirksamkeit von L-Dopa erhöht, das zur Behandlung von Morbus Parkinson verwendet wird, indem es eine höhere Konzentration an Dopamin im Gehirn ermöglicht, da das L Dopa peripher nicht abgebaut wird. \n→ Indikation: Morbus Parkinson \n→ Nebenwirkungen: Übelkeit, Durchfall, Verstopfung, Erbrechen, Herzklopfen, Kopfschmerzen, Schwindel \n→ Kontraindikation: Leberfunktionsstörungen, bestehende Darm- oder Leberprobleme, Herzinsuffizienz, Anamie, Schockzustände, bestehende Harnwegsprobleme, Schwangerschaft und Stillzeit.',
  'Rasalagin?':
      ' \n→ Wirkstoffklasse: MAO-B-Inhibitor \n→ Wirkmechanismus: der Wirkstoff ist ein Hemmer des Monoaminooxidase-B (MAO-B) Enzyms, das an der Abbau von Dopamin beteiligt ist. Dadurch wird die Menge an Dopamin im Gehirn erhöht und die motorischen Symptome bei Morbus Parkinson verbessert. \n→ Indikation: Morbus Parkinson \n→ Nebenwirkungen: Übelkeit, Erbrechen, Durchfall, Schläfrigkeit, Kopfschmerzen, Mundtrockenheit, orthostatische Hypotonie \n→ Kontraindikation: Überempfindlichkeit gegen den Wirkstoff, gleichzeitige Anwendung von Linezolid, SSRI oder Tramadol, akute Überdosis von mehr als 20 mg Tyramin',
  'Safinamid?':
      ' \n→ Wirkstoffklasse: MAO-B-Inhibitor \n→ Wirkmechanismus: der Wirkstoff ist ein Hemmer des Monoaminooxidase-B (MAO-B) Enzyms, das an der Abbau von Dopamin beteiligt ist. Dadurch wird die Menge an Dopamin im Gehirn erhöht und die motorischen Symptome bei Morbus Parkinson verbessert. \n→ Indikation: Morbus Parkinson \n→ Nebenwirkungen: Übelkeit, Durchfall, Mundtrockenheit, Schläfrigkeit, Benommenheit, Schwindel \n→ Kontraindikation: Überempfindlichkeit gegen den Wirkstoff, gleichzeitige Anwendung von Linezolid, SSRI oder Tramadol, akute Überdosis von mehr als 20 mg Tyramin',
  'Pramipexol/Ropinirol?':
      ' \n→ Wirkstoffklasse: Dopaminagonist - nicht Ergoline \n→ Wirkmechanismus: der Wirkstoff ist ein Dopaminagonist, der direkt an die Dopamin-Rezeptoren bindet und so die dopaminerge Aktivität im Gehirn steigert. Dies hilft, die Symptome des Morbus Parkinson, wie Bewegungsstörungen und Verlangsamung, zu verbessern. Schlechter wirksam als L-Dopa, aber keine Langzeitproblematik \n→ Indikation: 1. Wahl bei Dopaminagonisten Morbus Parkinson \n→ Nebenwirkungen: Übelkeit, Schwindel, Schläfrigkeit, Verwirrtheit, Halluzinationen, Schlafstörungen, Tagesmüdigkeit \n→ Kontraindikation: Überempfindlichkeit gegenüber dem Wirkstoff oder anderen Dopaminagonisten',
  'Rotigotin?':
      ' \n→ Wirkstoffklasse: Dopamin-Agonist / Transdermales Pflaster - nicht Ergoline \n→ Wirkmechanismus: Rotigotin ist ein Dopaminagonist, der durch ein transdermales Pflaster lokal aufgetragen wird. Es bindet direkt an die Dopamin-Rezeptoren im Gehirn und steigert so die dopaminerge Aktivität. Dies hilft, die Symptome des Morbus Parkinson, wie Bewegungsstörungen und Verlangsamung, zu verbessern. \n→ Indikation: Morbus Parkinson \n→ Nebenwirkungen: Übelkeit, Schwindel, Schläfrigkeit, Verwirrtheit, Halluzinationen, Schlafstörungen, Tagesmüdigkeit \n→ Kontraindikation: Überempfindlichkeit gegenüber Rotigotin oder anderen Dopaminagonisten',
  'Bromocriptin/Lisurid/Pergolid/Cabergolin?':
      ' \n→ Wirkstoffklasse: Dopamin-Agonist - Ergolin \n→ Wirkmechanismus: Bromocriptin ist ein Agonist des Dopamin-Rezeptors, was bedeutet, dass es die Wirkung von Dopamin im Gehirn nachahmt. Es wird zur Behandlung von Morbus Parkinson verwendet, indem es den Mangel an natürlichem Dopamin ausgleicht und die motorischen Symptome verbessert. \n→ Indikation: Morbus Parkinson \n→ Nebenwirkungen: Übelkeit, Schwindel, Kopfschmerzen, Erbrechen, Bluthochdruck, retroperitoneale und pleurale Fibrosen \n→ Kontraindikation: Überempfindlichkeit gegenüber Bromocriptin oder einen anderen Bestandteilen des Medikaments, mit Schizophrenie oder Psychose diagnostizierte Patienten.',
  'Biperidon/Procyclidin/Trihexylphenidyl?':
      ' \n→ Wirkstoffklasse: Antiparkinson-Medikament - Muscarin Rezeptor Antagonist \n→ Wirkmechanismus: Biperidon ist ein Antiparkinson-Medikament, das den Dopamin-Mangel im Gehirn kompensiert, indem es den Cholinergen Überschuss hemmt. Dies führt zur Verbesserung der motorischen Funktionen und Linderung der Parkinson-Symptome wie Zittern, Verlangsamung der Bewegungen und Muskelsteifheit. \n→ Indikation: Morbus Parkinson, da bessere ZNS Gängigkeit als Atropin \n→ Nebenwirkungen: Übelkeit, Mundtrockenheit, Verstopfung, Schläfrigkeit, Schwindel, Blurred Vision, Benommenheit, Überempfindlichkeitsreaktionen, Obstipation, Harnretention, Akkomodationsstörungen (periphere anticholinerge Effekte), Halluzinationen, Erregung, Delir (zentrale anticholinerge Effekte) \n→ Kontraindikation: Überempfindlichkeit gegenüber Biperidon oder einem der Inhaltsstoffe, Prostatahyperplasie, Blasenentleerungsstörungen',
  'Amantadin?(Parkinson)':
      ' \n→ Wirkstoffklasse: Antimuscarinischer Stoff \n→ Wirkmechanismus: der Wirkstoff ist ein NMDA Antagonist, der zu einer verminderten Aktivierung der GABA-Interneurone führt → Minderung Glutamaterger Einflüsse. Wirkung lässt jedoch nach Monaten nach. \n→ Indikation: Morbus Parkinson, oft kombiniert mit MAO B Hemmern \n→ Nebenwirkungen: Übelkeit, Verstopfung, Schläfrigkeit, Kopfschmerzen, Schwindel, Halluzinationen, verändertes Schlafmuster \n→ Kontraindikation: Überempfindlichkeit gegenüber dem Wirkstoff'
};

Map<String, String> neuroleptika = {
  'Benzodiazepine?(Manie)':
      ' \n→ Wirkstoffklasse: Psychopharmaka \n→ Wirkmechanismus: der Wirkstoff wirkt durch Erhöhung des GABA-Signalgehalts im Gehirn und führen dadurch zu einer Reduktion der Aktivität im Zentralnervensystem (ZNS). Dies führt zu einer beruhigenden, angstlösenden und krampflösenden Wirkung. \n→ Indikation: Bipolare Störung zur Akutbehandlung der Manie \n→ Nebenwirkungen: Müdigkeit, Benommenheit, Verwirrtheit, Konzentrationsstörungen, Koordinationsstörungen, Abhängigkeit \n→ Kontraindikation: Atemdepression, Alkohol- und/oder Drogenabhängigkeit, Akute Nieren- oder Lebererkrankungen',
  'Neuroleptika?':
      ' \n→ Wirkstoffklasse: Psychopharmaka \n→ Wirkmechanismus: Neuroleptika wirken auf den Dopamin-Rezeptor und führen zu einer Dämpfung der Dopamin-vermittelten Aktivität im Gehirn. Dies führt zu einer Reduktion von manischen und psychotischen Symptomen. \n→ Indikation: Schizophrenie, manische Episoden bei bipolarer Störung, Psychose \n→ Nebenwirkungen: Überwachsung, Antriebsstörungen, Mundtrockenheit, Verstopfung, Übergewicht, Verwirrtheit, Hitzewallungen \n→ Kontraindikation: Parkinson-Krankheit, Pädiatrische Anwendung, Überempfindlichkeit auf Neuroleptika',
  'Carbamazepin/Valproat?':
      ' \n→ Wirkstoffklasse: Antiepileptika \n→ Wirkmechanismus: der Wirkstoff wirkt durch Hemmung von Überaktivität und Synchronisation von Neuronen im Gehirn. Dadurch werden Krampfanfälle reduziert. \n→ Indikation: Epilepsie, bipolare Störung, Schmerzstörungen, schwächere Wirkung als Lithium, aber besser bei dysphorischer Manie, bessere Verträglichkeit \n→ Nebenwirkungen: Übelkeit, Durchfall, Kopfschmerzen, Verwirrtheit, Hautausschläge, Gewichtszunahme, Benommenheit \n→ Kontraindikation: Überempfindlichkeit auf Antiepileptika, Lebererkrankungen, Pädiatrische Anwendung',
  'Lithium?':
      ' \n→ Wirkstoffklasse: Klassische Antimanie-Medikament \n→ Wirkmechanismus: der Wirkstoff reguliert den Gehalt an Neurotransmittern wie Serotonin und Noradrenalin im Gehirn und beeinflusst somit die Stimmung. Es wird angenommen, dass der Wirkstoff den Wiederaufnahme von Neurotransmittern hemmt und die Konzentration dieser Botenstoffe im Synapsenspalt erhöht, was zu einer Stabilisierung der Stimmung und einer Verringerung manischer Symptome führt. \n→ Indikation: 1. Wahl bei Manische Episode bei bipolarer Störung \n→ Nebenwirkungen: Übelkeit, Durchfall, Erbrechen, Gewichtszunahme, Muskelschmerzen, Schwindel, Schwäche, trockene Haut, Durst, Bauchschmerzen, Tremor, mnestische Störungen, TSH Anstieg, Hypothyreose \n→ Kontraindikation: Nierenfunktionsstörungen, Herzprobleme, Dehydration.',
  'Chloroprothixen?':
      ' \n→ Wirkstoffklasse: Thioxanthen-Derivat - klassisch niederpotentes, sedierendes Neuroleptikum \n→ Wirkmechanismus: der Wirkstoff wird zur Behandlung von psychischen Störungen, insbesondere Schizophrenie und manischer Episode eingesetzt. Es wirkt durch Hemmung der Rezeptoraktivität für Dopamin (D2) im Gehirn und verringert so die psychotischen Symptome und die Stimmungsaufhellung bei manischer Episode. Wirken auf mesolimbischen System zur antipsychotischen Wirkung. Wirken auf Area postrema zur antiemetischer Wirkung. Wirkung auf das nigrostriären System zu extrapyramidale-motorischen Störungen. Wirkung auf das tuberoinfundibulären System zu endokrinen Wirkung. Wirken zusätzlich sedierend und vegetativ (alpha und Muskarin Rezeptor Blockade) \n→ Indikation: Schizophrenie, manische Episode \n→ Nebenwirkungen: Sedierung, extrapyramidale Symptome, Übelkeit, Mundtrockenheit, Verstopfung, Gewichtszunahme, keine Abhängigkeit und Atemdepression! \n→ Kontraindikation: Epilepsie, parkinsonische Symptome, Prostatahyperplasie, Schwangerschaft und Stillzeit',
  'Melperon?':
      ' \n→ Wirkstoffklasse: Phenylbutan-Derivat - klassisch niederpotentes Neuroleptikum \n→ Wirkmechanismus: der Wirkstoff wird zur Behandlung von psychischen Störungen, insbesondere Schizophrenie und manischer Episode eingesetzt. Es wirkt durch Hemmung der Rezeptoraktivität für Dopamin (D2) im Gehirn und verringert so die psychotischen Symptome und die Stimmungsaufhellung bei manischer Episode. Wirken auf mesolimbischen System zur antipsychotischen Wirkung. Wirken auf Area postrema zur antiemetischer Wirkung. Wirkung auf das nigrostriären System zu extrapyramidale-motorischen Störungen. Wirkung auf das tuberoinfundibulären System zu endokrinen Wirkung. Wirken zusätzlich sedierend und vegetativ (weniger als Chlorprothixen - alpha und Muskarin Rezeptor Blockade) \n→ Indikation: Schizophrenie, manische Episode \n→ Nebenwirkungen: extrapyramidale Symptome, Übelkeit, Mundtrockenheit, Verstopfung, Gewichtszunahme, Verwirrtheit \n→ Kontraindikation: Epilepsie, parkinsonische Symptome, Prostatahyperplasie, Schwangerschaft und Stillzeit',
  'Haloperidol/Fluphenazin?':
      ' \n→ Wirkstoffklasse: Butyrophenon-Derivat - klassisch hochpotentes Neuroleptikum \n→ Wirkmechanismus: der Wirkstoff wird zur Behandlung von psychischen Störungen, insbesondere Schizophrenie und manischer Episode eingesetzt. Es wirkt durch Hemmung der Rezeptoraktivität für Dopamin (D2) im Gehirn und verringert so die psychotischen Symptome und die Stimmungsaufhellung bei manischer Episode. Wirken auf mesolimbischen System zur antipsychotischen Wirkung. Wirken auf Area postrema zur antiemetischer Wirkung. Wirkung auf das nigrostriären System zu extrapyramidale-motorischen Störungen. Wirkung auf das tuberoinfundibulären System zu endokrinen Wirkung. Als hochpotentes Neuroleptikum vor allem Wirkung auf plus Symptomatik, weniger auf minus Symptomatik \n→ Indikation: Schizophrenie, manische Episode \n→ Nebenwirkungen: extrapyramidale Symptome, Übelkeit, Mundtrockenheit, Verstopfung, Gewichtszunahme, Verwirrtheit \n→ Kontraindikation: Epilepsie, parkinsonische Symptome, Prostatahyperplasie, Schwangerschaft und Stillzeit',
  'Clozapin?':
      ' \n→ Wirkstoffklasse: Atypisches Neuroleptikum \n→ Wirkmechanismus: der Wirkstoff wirkt durch Blockade von Dopamin(D2)- und Serotonin(5HT-2A)-Rezeptoren im Gehirn. Es hat eine besondere Wirksamkeit gegen negative und kognitive Symptome bei Schizophrenie, sowie gegen depressive Symptome bei bipolarer Störung. Weniger Wirkung auf extrapyramidale Motorik. Bessere Wirkung auf minus Symptomatik, oft wirksam bei therapieresistenten Schizophrenien. Zudem Muskarin Rezeptor Blockade gegen extrapyramidal-motorische Störungen \n→ Indikation: Ersatzpharmakon bei Schizophrenie, Bipolare Störung, Resistente Depression \n→ Nebenwirkungen: Übelkeit, Verstopfung, Mundtrockenheit, Gewichtszunahme, Benommenheit, Tardive Dyskinesie, Agranulozytose \n→ Kontraindikation: bei bekannter Überempfindlichkeit gegen Neuroleptika, bei bestehender kardialer Instabilität',
  'Olanzapin?':
      ' \n→ Wirkstoffklasse: Atypisches Neuroleptikum \n→ Wirkmechanismus: der Wirkstoff wirkt durch Blockade von Dopamin(D2)- und Serotonin(5HT-2A)-Rezeptoren im Gehirn. Es hat eine besondere Wirksamkeit gegen positive, negative und kognitive Symptome bei Schizophrenie. \n→ Indikation: Standardpräparat als Atypikum Schizophrenie, Bipolare Störung, akute manische Episode \n→ Nebenwirkungen: Übelkeit, Verstopfung, Mundtrockenheit, Gewichtszunahme, Benommenheit, Tardive Dyskinesie \n→ Kontraindikation: bei bekannter Überempfindlichkeit gegen Neuroleptika, bei bestehender kardialer Instabilität',
  'Quetiapin?':
      ' \n→ Wirkstoffklasse: atypisches Neuroleptikum \n→ Wirkmechanismus: das Arzneimittel ist ein Antipsychotikum, das den Dopamin(D2)- und Serotonin(5-HT2A)-Rezeptor hemmt. Dies führt zur Reduktion der Überaktivität der Neuronen im Gehirn, was wiederum bei psychischen Störungen, wie Schizophrenie und Manie, hilfreich sein kann. sowohl negativ, als auch positiv Symptomatik verbessert \n→ Indikation: Standard Atypikum bei Schizophrenie, manische Episode bei bipolarer Störung \n→ Nebenwirkungen: Schläfrigkeit, Gewichtszunahme, Mundtrockenheit, Verstopfung, Senkung des Blutdrucks bei plötzlicher Aufstehung \n→ Kontraindikation: Überempfindlichkeit gegenüber dem Wirkstoff, akute Überdosis an Neuroleptika.',
  'Amisulprid?':
      ' \n→ Wirkstoffklasse: Atypische Antipsychotika \n→ Wirkmechanismus: der Wirkstoff ist ein atypisches Antipsychotikum, das hauptsächlich durch Hemmung der Dopamin-Rezeptoren im Gehirn wirkt. Es hat eine höhere Affinität für die D2-Rezeptoren im Gehirn als für die D1-Rezeptoren und wird daher häufig bei der Behandlung von Schizophrenie und Bipolar-Störungen verwendet. \n→ Indikation: Standard Atypikum Schizophrenie, bipolare Störungen \n→ Nebenwirkungen: Übelkeit, Durchfall, Kopfschmerzen, Schläfrigkeit, Schlafstörungen, Mundtrockenheit \n→ Kontraindikation: Überempfindlichkeit gegen den Wirkstoff, akute manische oder hypomanische Episode',
  'Risperidon?':
      ' \n→ Wirkstoffklasse: Atypische Antipsychotika \n→ Wirkmechanismus: der Wirkstoff ist ein atypisches Antipsychotikum, das durch Hemmung von Dopamin- und Serotonin-Rezeptoren im Gehirn wirkt. Es hat eine höhere Affinität für Serotonin- als für Dopamin-Rezeptoren und wird häufig bei der Behandlung von Schizophrenie, bipolaren Störungen und Autismus verwendet. \n→ Indikation: Standard Atypikum bei Schizophrenie, bipolare Störungen, Autismus \n→ Nebenwirkungen: Übelkeit, Durchfall, Schläfrigkeit, Gewichtszunahme, Mundtrockenheit, Verwirrung \n→ Kontraindikation: Überempfindlichkeit gegen den Wirkstoff, akute manische oder hypomanische Episode',
  'Aripiprazol?':
      ' \n→ Wirkstoffklasse: Atypische Antipsychotika \n→ Wirkmechanismus: der Wirkstoff ist ein atypisches Antipsychotikum, das durch Modulation von Dopamin- und Serotonin-Rezeptoren (5HT2A Rezeptor Blockade) im Gehirn wirkt. Es ist ein Dopamin-Partialagonist und ein Serotonin-Partialagonist und wird häufig bei der Behandlung von Schizophrenie, bipolaren Störungen und Depressionen verwendet. Psychotische Symptomatik kann verschlechtert werden. \n→ Indikation: Standard Atypikum bei Schizophrenie, bipolare Störungen, Depressionen \n→ Nebenwirkungen: Übelkeit, Durchfall, Schläfrigkeit, Kopfschmerzen, Mundtrockenheit, Gewichtszunahme \n→ Kontraindikation: Überempfindlichkeit gegen den Wirkstoff, akute manische oder hypomanische Episode',
  'Cariprazin?':
      ' \n→ Wirkstoffklasse: Atypische Antipsychotika \n→ Wirkmechanismus: der Wirkstoff ist ein atypisches Antipsychotikum, das durch Modulation von Dopamin(Partialagonist am D2 und D3)- und Serotonin-Rezeptoren im Gehirn wirkt. Es ist ein Dopamin-Partialagonist und ein Serotonin-Partialagonist und wird häufig bei der Behandlung von Schizophrenie, bipolaren Störungen und Depressionen verwendet. Auch wirksam bei Minus Symptomatik \n→ Indikation: Standard Atypikum bei Schizophrenie, bipolare Störungen, Depressionen \n→ Nebenwirkungen: Übelkeit, Durchfall, Schläfrigkeit, Kopfschmerzen, Mundtrockenheit, Gewichtszunahme \n→ Kontraindikation: Überempfindlichkeit gegen den Wirkstoff',
  'Brexpiprazol?':
      ' \n→ Wirkstoffklasse: Atypische Antipsychotika \n→ Wirkmechanismus: der Wirkstoff ist ein atypisches Antipsychotikum, das durch Modulation von Dopamin(Partialagonist am D2 und D3)- und Serotonin-Rezeptoren im Gehirn wirkt. Es ist ein Dopamin-Partialagonist und ein Serotonin-Partialagonist und wird häufig bei der Behandlung von Schizophrenie, bipolaren Störungen und Depressionen verwendet. Auch wirksam bei Minus Symptomatik \n→ Indikation: Standard Atypikum bei Schizophrenie, bipolare Störungen, Depressionen \n→ Nebenwirkungen: Übelkeit, Durchfall, Schläfrigkeit, Kopfschmerzen, Mundtrockenheit, Gewichtszunahme \n→ Kontraindikation: Überempfindlichkeit gegen den Wirkstoff',
  'Pimavanserin?':
      ' \n→ Wirkstoffklasse: Antagonist für den Serotonin-2A-Rezeptor \n→ Wirkmechanismus: Pimavanserin ist ein Antagonist für den Serotonin-2A-Rezeptor und wirkt dadurch auf die Aktivität von Serotonin im Gehirn ein. Es wurde speziell für die Behandlung von psychotischen Symptomen bei Patienten mit Parkinson-Krankheit entwickelt und ist zugelassen für die Behandlung von Halluzinationen und Verwirrtheit bei dieser Erkrankung. \n→ Indikation: Halluzinationen und Verwirrtheit bei Parkinson-Krankheit \n→ Nebenwirkungen: Übelkeit, Ermüdung, Durchfall, Schwindel, Schläfrigkeit, Appetitverlust, Verwirrung, Angst \n→ Kontraindikation: Keine bekannten Kontraindikationen für die Verwendung bei Manie. Es ist jedoch wichtig, einen Arzt zu konsultieren, bevor man das Medikament einnimmt, um mögliche Wechselwirkungen mit anderen Medikamenten zu vermeiden.',
};

Map<String, String> antidepressiva = {
  'Amitriptylin/Doxepin?':
      ' \n→ Wirkstoffklasse: Tricyclische Antidepressiva \n→ Wirkmechanismus: Serotonin-Transporter (SERT) und den Noradrenalinn-Transporter (NET) werden blockiert. Es kommt zu einer verlängerten Verweildauer von Noradrenalin und Serotonin. Gilt als psychomotorisch hemmend und dämpfend. \n→ Indikation: 2. Wahl bei Depression, Angststörungen, Schlafstörungen, Schmerzstörungen \n→ Nebenwirkungen: Müdigkeit, Gewichtszunahme, Mundtrockenheit, Schwindel, Benommenheit, Verstopfung, Übelkeit, Erhöhter Puls, anticholinerge Effekte, kardiovaskuläre Wirkungen, Kardiotoxizität, Übergewicht \n→ Kontraindikation: Vorbestehende Herz-Kreislauf-Erkrankungen, Nierenfunktionsstörungen, Vorbestehende Leberfunktionsstörungen',
  'Imipramin/Clomipramin?':
      ' \n→ Wirkstoffklasse: Tricyclische Antidepressiva \n→ Wirkmechanismus: Serotonin-Transporter (SERT) und den Noradrenalinn-Transporter (NET) werden blockiert. Es kommt zu einer verlängerten Verweildauer von Noradrenalin und Serotonin. Gilt als psychomotorisch neutral. Zudem variable Wirkung an Muskarin-ACh Rezeptoren, alpha 1 und H1 Rezeptorern \n→ Indikation: 2. Wahl Depression, Angststörungen, Schlafstörungen, Schmerzstörungen \n→ Nebenwirkungen: Müdigkeit, Gewichtszunahme, Mundtrockenheit, Schwindel, Benommenheit, Verstopfung, Übelkeit, Erhöhter Puls, anticholinerge Effekte, kardiovaskuläre Wirkungen, Kardiotoxizität, Übergewicht \n→ Kontraindikation: Vorbestehende Herz-Kreislauf-Erkrankungen, Nierenfunktionsstörungen, Vorbestehende Leberfunktionsstörungen',
  'Nortriptylin?':
      ' \n→ Wirkstoffklasse: Tricyclisches Antidepressivum \n→ Wirkmechanismus: Serotonin-Transporter (SERT) und den Noradrenalinn-Transporter (NET) werden blockiert. Es kommt zu einer verlängerten Verweildauer von Noradrenalin und Serotonin. Gilt als psychomotorisch aktivierend (Suizidgefahr). Zudem variable Wirkung an Muskarin-ACh Rezeptoren, alpha 1 und H1 Rezeptorern \n→ Indikation: 2. Wahl Depressionen \n→ Nebenwirkungen: Mundtrockenheit, Verstopfung, Übelkeit, Benommenheit, Kopfschmerzen, Gewichtszunahme, Libidoverlust, anticholinerge Effekte, kardiovaskuläre Wirkungen, Kardiotoxizität, Übergewicht \n→ Kontraindikation: Überempfindlichkeit gegen den Wirkstoff, Vorhofflimmern, Herzinsuffizienz, schwere Leber- oder Nierenfunktionsstörungen, Verabreichung von MAO-Hemmern innerhalb der letzten 2 Wochen.',
  'Eszitalopram?':
      ' \n→ Wirkstoffklasse: Selektive Serotonin-Wiederaufnahmehemmer (SSRI) \n→ Wirkmechanismus: Eszitalopram hemmt die Wiederaufnahme von Serotonin in den Neuronen. Dadurch erhöht sich die Serotonin-Konzentration im synaptischen Spalt, was zu einer Verbesserung der Stimmung und Reduktion von Angststörungen beitragen kann. \n→ Indikation: 1. Wahl bei Major Depression, Generalisierte Angststörung, Panikstörung, soziale Angststörung, auch bei Schwangerschaft anwendbar \n→ Nebenwirkungen: Übelkeit, Durchfall, Kopfschmerzen, Schlaflosigkeit, Benommenheit, Müdigkeit, sexuelle Funktionsstörungen, keine Gewichtszunahme, weniger starke anticholinerge, weniger sedierende und kardiale Wirkung \n→ Kontraindikation: Überempfindlichkeit gegen den Wirkstoff, schwere Leberfunktionsstörungen, plötzlicher Wiederaufnahmestopp von Alkohol oder anderen hypnotischen Substanzen, Kombination mit MAO Hemmern oder Tryptophan',
  'Citalopram?':
      ' \n→ Wirkstoffklasse: Selektive Serotonin-Wiederaufnahmehemmer (SSRI) \n→ Wirkmechanismus: Citalopram hemmt die Wiederaufnahme von Serotonin in den Neuronen. Dadurch erhöht sich die Serotonin-Konzentration im synaptischen Spalt, was zu einer Verbesserung der Stimmung und Reduktion von Angststörungen beitragen kann. \n→ Indikation: 1. Wahl bei Major Depression, Generalisierte Angststörung, Panikstörung, soziale Angststörung, auch bei Schwangerschaft anwendbar \n→ Nebenwirkungen: Übelkeit, Durchfall, Kopfschmerzen, Schlaflosigkeit, Benommenheit, Müdigkeit, sexuelle Funktionsstörungen, keine Gewichtszunahme, weniger starke anticholinerge, weniger sedierende und kardiale Wirkung \n→ Kontraindikation: Überempfindlichkeit gegen den Wirkstoff, schwere Leberfunktionsstörungen, plötzlicher Wiederaufnahmestopp von Alkohol oder anderen hypnotischen Substanzen, Kombination mit MAO Hemmern oder Tryptophan',
  'Sertralin?':
      ' \n→ Wirkstoffklasse: Selektive Serotonin-Wiederaufnahmehemmer (SSRI) \n→ Wirkmechanismus: Sertralin hemmt die Wiederaufnahme von Serotonin in den Neuronen. Dadurch erhöht sich die Serotonin-Konzentration im synaptischen Spalt, was zu einer Verbesserung der Stimmung und Reduktion von Angststörungen beitragen kann. \n→ Indikation: 1. Wahl bei Major Depression, Generalisierte Angststörung, Panikstörung, soziale Angststörung, Posttraumatische Belastungsstörung (PTBS), auch bei Schwangerschaft anwendbar \n→ Nebenwirkungen: Übelkeit, Durchfall, Kopfschmerzen, Schlaflosigkeit, Benommenheit, Müdigkeit, keine Gewichtszunahme, weniger starke anticholinerge, weniger sedierende und kardiale Wirkung \n→ Kontraindikation: Überempfindlichkeit gegen den Wirkstoff, schwere Leberfunktionsstörungen, plötzlicher Wiederaufnahmestopp von Alkohol oder anderen hypnotischen Substanzen, Kombination mit MAO Hemmern oder Tryptophan',
  'Fluvoxamin?':
      ' \n→ Wirkstoffklasse: SSRI (selektive Serotonin-Wiederaufnahme-Hemmer) \n→ Wirkmechanismus: der Wirkstoff hemmt die Wiederaufnahme von Serotonin in die Neuronen, was zu einer Verstärkung der Serotonin-Signale führt. Dies kann eine Verbesserung von Depressionen, Angstzuständen und Zwängen bewirken. \n→ Indikation: Behandlung von Depressionen, Zwängen und obsessive-compulsive Störungen \n→ Nebenwirkungen: Übelkeit, Durchfall, Kopfschmerzen, Schlaflosigkeit, sexuelle Funktionsstörungen, Überempfindlichkeitsreaktionen \n→ Kontraindikation: Schwangerschaft, Stillzeit, Überempfindlichkeit gegenüber dem Wirkstoff oder einem anderen SSRI.',
  'Fluoxetin?':
      ' \n→ Wirkstoffklasse: SSRI (selektive Serotonin-Wiederaufnahme-Hemmer) \n→ Wirkmechanismus: der Wirkstoff hemmt die Wiederaufnahme von Serotonin in die Neuronen, was zu einer Verstärkung der Serotonin-Signale führt. Dies kann eine Verbesserung von Depressionen, Angstzuständen und Zwängen bewirken. \n→ Indikation: Behandlung von Depressionen, Bulimie, Premenstruellen Dysphorischen Störungen \n→ Nebenwirkungen: Übelkeit, Durchfall, Kopfschmerzen, Schlaflosigkeit, sexuelle Funktionsstörungen, Überempfindlichkeitsreaktionen \n→ Kontraindikation: Schwangerschaft, Stillzeit, Überempfindlichkeit gegenüber dem Wirkstoff oder einem anderen SSRI.',
  'Reboxetin?':
      ' \n→ Wirkstoffklasse: Noradrenalin-Wiederaufnahmehemmer \n→ Wirkmechanismus: der Wirkstoff hemmt die Wiederaufnahme von Noradrenalin in die Neuronen, wodurch dessen Konzentration im synaptischen Spalt erhöht wird. Dies führt zu einer Stimulation des noradrenalinergen Systems und einer Verbesserung der Stimmung und des Antriebs. \n→ Indikation: Depression \n→ Nebenwirkungen: Übelkeit, Erbrechen, Mundtrockenheit, Schlafstörungen, Kopfschmerzen, Durchfall \n→ Kontraindikation: Überempfindlichkeit gegenüber dem Wirkstoff, schwere Leber- und Nierenerkrankungen, kardiovaskuläre Erkrankungen, keine Kombination mit MAO Hemmern',
  'Venlafaxin/Duloxetin?':
      ' \n→ Wirkstoffklasse: Serotonin- und Noradrenalin-Wiederaufnahmehemmer (SNRI) \n→ Wirkmechanismus: Venlafaxin/Duloxetin hemmen die Wiederaufnahme von Serotonin und Noradrenalin in die Neuronen, wodurch deren Konzentration im synaptischen Spalt erhöht wird. Dies führt zu einer Stimulation beider serotonerger und noradrenalerger Systeme und einer Verbesserung von Stimmung und Antrieb. \n→ Indikation: Depression, Angststörungen \n→ Nebenwirkungen: Übelkeit, Durchfall, Schlafstörungen, Kopfschmerzen, Schwindel, trockener Mund, änstliche Unruhe, Blutdruckanstieg \n→ Kontraindikation: Überempfindlichkeit gegenüber dem Wirkstoff, schwere Leber- und Nierenerkrankungen, kardiovaskuläre Erkrankungen, Kombination mit MAO Hemmern',
  'Mirtazapin?':
      ' \n→ Wirkstoffklasse: Noradrenalin- und Serotonin-Antagonist (NaSSA) \n→ Wirkmechanismus: schneller Wirkeintritt. Mirtazapin hemmt die Wiederaufnahme von Noradrenalin und Serotonin in die Neuronen und blockiert gleichzeitig α2-adrenerge Rezeptoren. Dies führt zu einer Erhöhung der Konzentration von Noradrenalin und Serotonin im synaptischen Spalt und zu einer Verbesserung der Stimmung und des Antriebs. \n→ Indikation: Depression, Angststörungen \n→ Nebenwirkungen: Übelkeit, Gewichtszunahme, Mundtrockenheit, Schlafstörungen, Kopfschmerzen, Schwindel \n→ Kontraindikation: Überempfindlichkeit gegenüber dem Wirkstoff, schwere Leber- und Nierenerkrankungen, kardiovaskuläre Erkrankungen',
  'Bupropion?':
      ' \n→ Wirkstoffklasse: Antidepressivum und Raucherentwöhnungsmittel \n→ Wirkmechanismus: Bupropion wirkt als noradrenerger und dopaminerger Agonist und hemmt die Wiederaufnahme von Dopamin und Noradrenalin im Gehirn. Es verbessert dadurch die Stimmung und hilft bei der Raucherentwöhnung. \n→ Indikation: gehemmt depressive Patienten \n→ Nebenwirkungen: Kopfschmerzen, Schlafstörungen, Nervosität, Übelkeit, Durchfall, Mundtrockenheit, Blutdruckanstieg, Tachykardie, \n→ Kontraindikation: bekannte Überempfindlichkeit gegen den Wirkstoff, klinisch signifikante Leberfunktionsstörungen, bei bestehender Krise oder Vorhofflimmern, bei schweren Depressionen, keine Kombination mit MAO Hemmern, aber mit SSRI kombinierbar',
  'Agomelatin?':
      ' \n→ Wirkstoffklasse: Melatoninergo-Antidepressivum \n→ Wirkmechanismus: Agomelatin wird zu einem erhöhten Spiegel an Melatonin im Gehirn verstoffwechselt und bindet an Melatoninrezeptoren, was zu einer verbesserten Regulation des Schlaf-Wach-Rhythmus und einer Verbesserung der Stimmung führt. \n→ Indikation: Major Depression, Schlafstörungen \n→ Nebenwirkungen: Müdigkeit, Kopfschmerzen, Übelkeit, Durchfall \n→ Kontraindikation: bekannte Überempfindlichkeit gegen den Wirkstoff, Schwangerschaft und Stillzeit',
  'Moclobemid?':
      ' \n→ Wirkstoffklasse: Monoaminoxidase-A-Inhibitor (MAO-A-Inhibitor) \n→ Wirkmechanismus: Moclobemid hemmt die monoaminoxidase-A (MAO-A), ein Enzym, das für den Abbau von Neurotransmittern wie Serotonin, Noradrenalin und Dopamin verantwortlich ist. Durch die Hemmung dieses Enzyms steigt die Konzentration dieser Neurotransmitter im Gehirn und verbessert somit Stimmung und Antriebslage. \n→ Indikation: Depression, wirkt antriebssteigernd \n→ Nebenwirkungen: Übelkeit, Durchfall, Kopfschmerzen, Schwindel, Schwitzen \n→ Kontraindikation: bestehender klinischer Verdacht auf Phäochromozytom, bestehende Krise oder Vorhofflimmern, bestehender Hydrops oder Anasarka, bekannte Überempfindlichkeit gegen Moclobemid, keine Kobination mit SSRI und serotonergen Substanzen',
  'Johanniskraut?':
      ' \n→ Wirkstoffklasse: Antidepressivum \n→ Wirkmechanismus: der Arzneistoff enthält Wirkstoffe wie Hyperforin und Hypericin, die an Serotonin- und Noradrenalintransporter andocken und somit deren Spiegel erhöhen. Dadurch wird eine verbesserte Stimmung und eine Linderung von depressiven Symptomen erreicht. \n→ Indikation: leichte Depressionen \n→ Nebenwirkungen: Übelkeit, Durchfall, Magenbeschwerden, Kopfschmerzen, Müdigkeit, Sonnenbrand, verminderte Koordination \n→ Kontraindikation: Kombination mit anderen Antidepressiva oder anderen Medikamenten mit Wechselwirkungen, Schwangerschaft und Stillzeit, sowie einige Lebererkrankungen.',
};

Map<String, String> epilepsie = {
  'Levetiracetam?':
      ' \n→ Wirkstoffklasse: Antiepileptikum \n→ Wirkmechanismus: Der exakte Wirkmechanismus von diesem Wirkstoff ist noch unklar. Es wird angenommen, dass es den Übertrag von Impulsen zwischen Neuronen reduziert und so Anfälle unterdrückt. Dabei wird das synaptische Vesikelprotein 2A blockiert. \n→ Indikation: 1. Wahl bei Behandlung von fokalen Anfällen, GTKA, Myoklonischen Anfällen \n→ Dosierung: in wenigen Tagen eindosierbar \n→ Interaktionen: sehr gering \n→ Schwangerschaft: geringe Teratogenität \n→ Nebenwirkungen: Übelkeit, Kopfschmerzen, Müdigkeit, Verwirrung, Schlaflosigkeit, Psychiatrische Symptome \n→ Kontraindikation: Überempfindlichkeit gegen den Wirkstoff',
  'Lamotrigin?':
      ' \n→ Wirkstoffklasse: Antiepileptikum \n→ Wirkmechanismus: der Wirkstoff hemmt den Übertrag von Impulsen zwischen Neuronen über die Blockade spannungsabhängiger Na Kanäle und reduziert dadurch das Auftreten von Anfällen. \n→ Indikation: 1. Wahl bei Fokale Anfälle, generalisierte Anfälle, Lennox Gastaut Syndrom, bipolare Störung, ist das Mittel der ersten Wahl bei schwangeren Patientinnen als Breitspektrum AED \n→ Nebenwirkungen: Hautausschläge, Kopfschmerzen, Schwindel, Übelkeit, Koordinationsstörungen, Doppelsehen \n→ Dosierung: Sehr langsame Aufdosierung in 6-10 Wochen wegen Hautreaktionen \n→ Interaktionen: Östrogene und SS senken den LTG Wirkspiegel. VPA steigert ihn \n→ Kontraindikation: Überempfindlichkeit gegen den Wirkstoff, schwere Hautreaktionen',
  'Valproinsäure?':
      ' \n→ Wirkstoffklasse: Antiepileptikum, Mood Stabilizer \n→ Wirkmechanismus: der Wirkstoff wirkt über mehrere Mechanismen. 1. Natrium Kanalblocker, T-Typ Calcium Kanal Blocker, GABA Transaminase Hemmer, Histon Deacetylase Hemmer \n→ Indikation: 1. Wahl bei GTKA, Absencen als Breitspektrum AED \n→ Dosierung: oral in wenigen Tagen eindosierbar \n→ Nebenwirkungen: Übelkeit, Erbrechen, Durchfall, Kopfschmerzen, Gewichtszunahme, Haarausfall, Hepatotoxizität, Pankreatitis, Thrombozytopenie, Thrombozytendysfunktion \n→ Schwangerschaft: hohe Teratogenität \n→ Kontraindikation: Überempfindlichkeit gegen den Wirkstoff, Leberfunktionsstörungen',
  'Topiramat?':
      ' \n→ Wirkstoffklasse: Antiepileptikum \n→ Wirkmechanismus:Hemmung der Carboanhydrase → Excitation ↓. GABAerg → Inhibition ↑ Blockade von AMPA-Glutamat-Rezeptoren, Natrium- und Calciumkanalblocker → Excitation ↓ \n→ Indikation: 2. Wahl bei Fokale Anfälle, GTKA, LGS \n→ Nebenwirkungen: Übelkeit, Durchfall, Veränderungen des Geschmacks, Müdigkeit, Gewichtsverlust, Konzentrationsstörungen, Augentrockenheit, mentale Verlangsamung, Sprachstörungen, Parästhesien, Gewichtsverlust, Nierensteine \n→ Schwangerschaft: mittlere Teratogenität \n→ Kontraindikation: Nierenfunktionsstörungen, Schwangerschaft und Stillzeit',
  'Zonisamid?':
      ' \n→ Wirkstoffklasse: Antiepileptikum \n→ Wirkmechanismus: T-Typ-Calcium-Kanalblocker → Excitation ↓. Natriumkanal-Blocker → Signalübertragung ↓ → Excitation ↓. Carboanhydrasehemmer → Excitation ↓ \n→ Indikation: Fokale Anfälle, Breispektrum AED der zweiten Wahl \n→ Nebenwirkungen: Übelkeit, Durchfall, Veränderungen des Geschmacks, Abneigung gegenüber bestimmten Lebensmitteln, Verminderung der Körperfettmasse, Konzentrationsstörungen, Müdigkeit, Schläfrigkeit \n→ Kontraindikation: Nierenfunktionsstörungen, Schwangerschaft und Stillzeit',
  'Phenobarbital?':
      ' \n→ Wirkstoffklasse: Barbiturat \n→ Wirkmechanismus: der Wirkstoff ist ein GABA A R Agonist und verlängert die Öffnungsdauer des Cl Kanals → hemmt dadurch die Überaktivität von Neuronen. Dies führt zu einer Verringerung der neuronalen Erregbarkeit und somit zur Verhinderung von Anfällen. \n→ Indikation: Reservemittel bei fokale Anfälle, sGTKA \n→ Nebenwirkungen: Müdigkeit, Benommenheit, Verwirrtheit, Koordinationsstörungen, Mundtrockenheit, Übelkeit, Erbrechen, Veränderungen des Appetits, Veränderungen des Gewichts, Atemdepression, Osteoporose, Fibrorisierung Handfläche/Fußsohle \n→ Interaktionen: hohe Interaktionspotential durch Enzyminduktion \n→ Kontraindikation: Schwangerschaft und Stillzeit, Nierenfunktionsstörungen, Leberfunktionsstörungen',
  'Primidon?':
      ' \n→ Wirkstoffklasse: Antiepileptikum \n→ Wirkmechanismus: GABA-A-R-Agonist → Öffnungsdauer Cl-Kanal ↑ → Inhibition ↑ \n→ Indikation: Reservemittel bei fokale Anfälle und sGTKA \n→ Nebenwirkungen: Übelkeit, Durchfall, Kopfschmerzen, Schläfrigkeit, Gewichtszunahme, Benommenheit \n→ Interaktionen: sehr hohes Potential durch Enzyminduktion \n→ Kontraindikation: Überempfindlichkeit gegenüber dem Wirkstoff, schwerwiegende Leber- oder Nierenerkrankungen',
  'Clobazam?':
      ' \n→ Wirkstoffklasse: Benzodiazepin \n→ Wirkmechanismus: GABA-A-R-Agonist → Öffnungsdauer Cl-Kanal ↑ → Inhibition ↑ \n→ Indikation: Angststörungen, Reservemittel bei Epilepsie (LGS) \n→ Nebenwirkungen: Sucht, Müdigkeit, Benommenheit, Schläfrigkeit, Koordinationsstörungen, Gedächtnisstörungen \n→ Kontraindikation: Überempfindlichkeit gegenüber dem Wirkstoff, schwerer Atemstillstand, schwere Nieren- oder Lebererkrankungen',
  'Clonazepam?':
      ' \n→ Wirkstoffklasse: Benzodiazepin \n→ Wirkmechanismus: GABA-A-R-Agonist → Öffnungsdauer Cl-Kanal ↑ → Inhibition ↑ \n→ Indikation: Reservemittel bei rAnfallsstörungen, Angststörungen, Muskelspannungen \n→ Nebenwirkungen: Müdigkeit, Benommenheit, Schläfrigkeit, Koordinationsstörungen, Gedächtnisstörungen \n→ Kontraindikation: Überempfindlichkeit gegenüber dem Wirkstoff, schwerer Atemstillstand, schwere Nieren- oder Lebererkrankungen',
  'Carbamazepin?':
      ' \n→ Wirkstoffklasse: Antikonvulsivum \n→ Wirkmechanismus: Natriumkanalblocker → Signalübertragung ↓ → Excitation ↓ \n→ Indikation: 1./2. Wahl bei fokale und sekundär generalisierte Anfälle, manische Phasen der bipolaren Störung \n→ Nebenwirkungen: Müdigkeit, Kopfschmerzen, Benommenheit, Übelkeit, Schwindel, Hautausschläge, Hyponatriämie, Osteoporose \n→ Interaktionen: hat ein hohes Interaktionspotential \n→ Schwangerschaft: Missbildungsrisiko ist eher niedrig \n→ Kontraindikation: Überempfindlichkeit gegenüber Carbamazepin oder einem seiner Inhaltsstoffe',
  'Oxcarbazepin?':
      ' \n→ Wirkstoffklasse: Antikonvulsivum \n→ Wirkmechanismus: der Wirkstoff ist ein Analogon von Carbamazepin und gehört ebenfalls zur Klasse der Antikonvulsiva. Es wirkt ähnlich wie Carbamazepin durch Hemmung der Integrität der Na+-Kanäle und unterdrückt somit die Überaktivität von Neuronen. \n→ Indikation: 1. Wahl bei fokale und sekundär generalisierte Anfälle \n→ Nebenwirkungen: Kopfschmerzen, Übelkeit, Schwindel, Benommenheit, Müdigkeit, Hautausschläge, Hyponatriämie \n→ Schwangerschaft: ein niedriges Missbildungsrisikos \n→ Kontraindikation: Überempfindlichkeit gegenüber dem Wirkstoff oder einem seiner Inhaltsstoffe, Diuretika verstärken die Hyponatriämie',
  'Eslicarbazepin?':
      ' \n→ Wirkstoffklasse: Antikonvulsivum \n→ Wirkmechanismus: der Wirkstoff gehört zur Klasse der Antikonvulsiva und wirkt durch Hemmung der Integrität der Na+-Kanäle. Es verhindert somit die Überaktivität von Neuronen und unterdrückt somit Konvulsionen. \n→ Indikation: 2. Wahl bei fokalen und sekundär generalisierten Anfällen \n→ Nebenwirkungen: Müdigkeit, Kopfschmerzen, Benommenheit, Übelkeit, Schwindel, Hautausschläge, Hyponatriämie \n→ Kontraindikation: Überempfindlichkeit gegenüber Eslicarbazepin oder einem seiner Inhaltsstoffe, Diuretika verstärken die Hyponatriämie',
  'Lacosamid?':
      ' \n→ Wirkstoffklasse: Anti-Arrhythmikum \n→ Wirkmechanismus: Lacosamid wird verwendet, um bestimmte Arrhythmien (Herzrhythmusstörungen) zu behandeln. Es hemmt den Natriumkanal und verlangsamt damit den Übergang von einem Aktionspotential zum nächsten, was zu einer Reduktion der Herzfrequenz führt. \n→ Indikation: Vorhofflimmern, fokale Anfälle, sekundäre GTKA \n→ Nebenwirkungen: Übelkeit, Durchfall, Müdigkeit, Kopfschmerzen, Herzklopfen \n→ Interaktionen: sehr geringes Interaktionsrisiko \n→ Kontraindikation: Überempfindlichkeit gegen Lacosamid oder andere Anti-Arrhythmika, bestimmte Herzkrankheiten, schwerwiegende Leberfunktionsstörungen',
  'Gabapentin?':
      ' \n→ Wirkstoffklasse: Antiepileptikum \n→ Wirkmechanismus: Blockt alpha2-delta-Untereinheit von präsynaptischen Calciumkanälen → Excitation ↓. Moderate GABAerge Wirkung \n→ Indikation: Fokale Anfälle, Epilepsie, neuropathische Schmerzen \n→ Nebenwirkungen: Müdigkeit, Schwindel, Kopfschmerzen, Übelkeit, Benommenheit, Gewichtszunahme \n→ Kontraindikation: Überempfindlichkeit gegen Gabapentin oder ähnliche Antiepileptika',
  'Pregabalin?':
      ' \n→ Wirkstoffklasse: Antiepileptikum, Antidepressivum \n→ Wirkmechanismus: Blockt alpha2-delta-Untereinheit von präsynaptischen Calciumkanälen → Excitation ↓. Moderate GABAerge Wirkung \n→ Indikation: Epilepsie (nicht so stark antikonvulsiv wie andere Präparate), neuropathische Schmerzen, Generalisierte Angststörung \n→ Nebenwirkungen: Müdigkeit, Schwindel, Kopfschmerzen, Übelkeit, Benommenheit, Gewichtszunahme, Verwirrtheit \n→ Kontraindikation: Überempfindlichkeit gegen Pregabalin oder ähnliche Antiepileptika, schwerwiegende Nierenfunktionsstörungen',
  'Phenytoin?':
      ' \n→ Wirkstoffklasse: Antiepileptikum \n→ Wirkmechanismus: Na+-Kanal-Blocker → Excitation ↓ \n→ Indikation: Reservemittel bei fokaler und sekundärer generalisierten Anfall, Status epilepticus \n→ Nebenwirkungen: Schwindel, Übelkeit, Mundtrockenheit, Verwirrtheit, Veränderung des Hauttons, Hirsutismus, Arrhytmien und Gewebenekrosen \n→ Interaktionen: sehr hohes Interaktionspotential \n→ Kontraindikation: bekannte Überempfindlichkeit gegen Phenytoin?',
  'Ethosuximid?':
      ' \n→ Wirkstoffklasse: Antiepileptikum \n→ Wirkmechanismus: Blockade postsynaptischer T-Typ-Calcium-Kanäle→ Excitation ↓ \n→ Indikation: Absence-Epilepsie (Petit-Mal-Epilepsie) \n→ Nebenwirkungen: Übelkeit, Kopfschmerzen, Schwindel, Müdigkeit \n→ Kontraindikation: bekannte Überempfindlichkeit gegen Ethosuximid oder einen anderen Bestandteil des Medikaments'
};

Map<String, String> alkoholUndNikotin = {
  'Ethanol?':
      ' \n→ Wirkstoffklasse: Alkohol \n→ Wirkmechanismus: der Wirkstoff ist ein klassischer Antidot für Methanol-Vergiftungen, indem es als Konkurrent für die gleiche metabolische Pathway wie Methanol eingreift. Es wird in der Leber in Aktivität konvertiert und verhindert so, dass Methanol zu Formaldehyd und Formiat metabolisiert wird, was zu schweren Vergiftungssymptomen führen kann. \n→ Indikation: Methanol-Vergiftung \n→ Nebenwirkungen: Übelkeit, Durchfall, Kopfschmerzen, Schwindel, Verwirrung, Atemdepression, Bewusstlosigkeit \n→ Kontraindikation: Alkoholismus, Leber- und Nierenerkrankungen',
  '4-Methylpyrazol?':
      ' \n→ Wirkstoffklasse: Alkohol-Dehydrogenase-Inhibitor \n→ Wirkmechanismus: der Wirkstoff ist ein Inhibitor der Alkohol-Dehydrogenase, eines Enzyms, das Methanol in seine toxischen Metaboliten umsetzt. Durch Hemmung dieses Enzyms wird die Toxizität von Methanol verhindert und eine Methanol-Vergiftung behandelt. \n→ Indikation: Methanol-Vergiftung \n→ Nebenwirkungen: Übelkeit, Durchfall, Kopfschmerzen, Verwirrung, Atemdepression, Bewusstlosigkeit \n→ Kontraindikation: nicht bekannt',
  'Ethanol?(Suchtstoff)':
      ' \n→ Wirkstoffklasse: Suchtstoff \n→ Wirkmechanismus: der Stoff wirkt als Zentralnervensystem-Depressivum und beeinflusst die Aktivität von Neuronen, die für Emotionen, Gedächtnis und Bewegung verantwortlich sind. Es hemmt die Übertragung von Signalen zwischen den Neuronen und führt zu einer Verringerung von Angst, Koordination und kognitiven Funktionen und Reaktionsgeschwindigkeit. Er hat sowohl Auswirkungen auf den GABA A Rezeptor (stimulierend), als auch auf den NMDA Rezeptor (inhibierend), Dopamin (stimulierend - auch auf das Belohnungssystem), Opioid-, Serotonin-, Cannabinoid Rezeptor (stimulierend). Außerdem Abnahme der Muskelleistung, Vasodilatation, Tachykardie, Hyper- oder Hypotonie, Tachypnoe, gesteigerte Diurese, Hypoglykämie \n→ Indikation: Als Auslöser für kurzzeitige Entspannung und Vergnügen wird Alkohol oft in sozialen Situationen konsumiert. \n→ Nebenwirkungen: Übelkeit, Kopfschmerzen, Schwindel, Verwirrtheit, Konzentrationsstörungen, Beeinträchtigung der kognitiven Funktionen, Beeinträchtigung der Kontrolle über die Bewegungen, Beeinträchtigung des Gedächtnisses, Übermäßige Schläfrigkeit oder Benommenheit \n→ Kontraindikation: Alkoholsucht, Leber- und Magenerkrankungen, Pankreaserkrankungen, Schlafstörungen, Depressionen und Angststörungen. Alkohol darf während der Schwangerschaft und Stillzeit nicht konsumiert werden, da es das Risiko von Geburtsfehlern und Entwicklungsstörungen bei dem Fötus erhöhen kann.',
  'Benzodiazepine?':
      ' \n→ Wirkstoffklasse: Benzodiazepin \n→ Wirkmechanismus: Benzodiazepine wirken durch Erhöhung des GABA-Spiegels im Gehirn und hemmen somit die Überaktivität von Neuronen, die für Angst, Spannung und Angstzustände verantwortlich sind. Dadurch wird eine beruhigende und angstlösende Wirkung erzielt. \n→ Indikation: Angststörungen, Schlafstörungen, Muskelverspannungen \n→ Nebenwirkungen: Müdigkeit, Benommenheit, Verwirrtheit, Gedächtnisstörungen \n→ Kontraindikation: Alkoholabhängigkeit (Benzodiazepine können bei abhängigen Personen eine Abhängigkeit auslösen)',
  'Oxazepam?':
      ' \n→ Wirkstoffklasse: Benzodiazepin \n→ Wirkmechanismus: Oxazepam wirkt ähnlich wie andere Benzodiazepine durch Erhöhung des GABA-Spiegels im Gehirn und hemmen somit die Überaktivität von Neuronen, die für Angst, Spannung und Angstzustände verantwortlich sind. \n→ Indikation: Angststörungen, Schlafstörungen \n→ Nebenwirkungen: Müdigkeit, Benommenheit, Verwirrtheit, Gedächtnisstörungen \n→ Kontraindikation: Alkoholabhängigkeit (Benzodiazepine können bei abhängigen Personen eine Abhängigkeit auslösen)',
  'Clomethiazol?':
      ' \n→ Wirkstoffklasse: Chlor-Substituiertes Ethylendiamin \n→ Wirkmechanismus: Clomethiazol wird bei Alkoholentzug eingesetzt, um die Entzugserscheinungen zu lindern. Es wirkt durch Hemmung der Aktivität von Neuronen im Gehirn, die für Angst, Stress und Entzugserscheinungen verantwortlich sind. \n→ Indikation: Alkoholentzug \n→ Nebenwirkungen: Müdigkeit, Benommenheit, Verwirrtheit, Kopfschmerzen \n→ Kontraindikation: Leber- und Nierenerkrankungen, Anfallsleiden, Überempfindlichkeit gegenüber Clomethiazol oder anderen Inhaltsstoffen des Medikaments.',
  'Halperidol?':
      ' \n→ Wirkstoffklasse: Neuroleptika \n→ Wirkmechanismus: der Wirkstoff wird als Neuroleptikum eingesetzt, um Schizophrenie, psychotische Störungen und manische Zustände zu behandeln. Es blockiert Dopaminerge Rezeptoren im Gehirn und verändert dadurch die chemische Kommunikation zwischen Neuronen. \n→ Indikation: Schizophrenie, psychotische Störungen, manische Zustände \n→ Nebenwirkungen: Übelkeit, Verstopfung, Mundtrockenheit, Schläfrigkeit, Gewichtszunahme, Veränderungen im Sexualverhalten, gestörte Bewegungskoordination \n→ Kontraindikation: Überempfindlichkeit gegenüber dem Wirkstoff, schwere Herz-Kreislauf-Erkrankungen, Parkinson-Krankheit, Akutpsychose',
  'Clonidin?(Alkohol)':
      ' \n→ Wirkstoffklasse: Adrenerge Agonisten \n→ Wirkmechanismus: der Wirkstoff wird als adrenerger Agonist verwendet, um Bluthochdruck zu behandeln, indem es den Adrenalinstoß reduziert, der bei Stress oder Angst auftritt. Es blockiert auch alpha-2-Adrenorezeptoren, die für die Regulation von Blutdruck und Herzfrequenz verantwortlich sind. \n→ Indikation: Bluthochdruck, Hyperhidrose, Alkoholentzugssyndrom \n→ Nebenwirkungen: Müdigkeit, Kopfschmerzen, Übelkeit, Schläfrigkeit, Mundtrockenheit, Verstopfung, verminderte Libido \n→ Kontraindikation: Überempfindlichkeit gegenüber dem Wirkstoff, schwerwiegende Herz-Kreislauf-Erkrankungen, Prostatahyperplasie, Nierenfunktionsstörungen.',
  'Thiamin (auch bekannt als Vitamin B1)?':
      ' \n→ Wirkstoffklasse: Biostoff \n→ Wirkmechanismus: Ist für den Stoffwechsel von Kohlenhydraten, Eiweißen und Fetten notwendig ist. Es spielt eine wichtige Rolle bei der Energieproduktion und bei der Übertragung von Nervenimpulsen. Ein Mangel an Thiamin kann zu einer Reihe von Gesundheitsproblemen führen, darunter Neuropathie, Herzinsuffizienz und Wernicke-Korsakoff-Syndrom. \n→ Indikation: Thiaminmangel, besonders bei alkoholabhängigen Patienten, die häufig einen Mangel an Vitaminen und Mineralstoffen aufweisen. \n→ Nebenwirkungen: Übelkeit, Erbrechen, Durchfall, allergische Reaktionen \n→ Kontraindikation: Personen mit einer Überempfindlichkeit gegen Thiamin sollten es nicht einnehmen.',
  'Disulfiram?':
      ' \n→ Wirkstoffklasse: Antabuse \n→ Wirkmechanismus: Wirkstoff ist ein Medikament, das bei der Behandlung von Alkoholismus eingesetzt wird. Es funktioniert indem es das Enzym Acetaldehyd-Dehydrogenase blockiert, was zu einer erhöhten Konzentration von Acetaldehyd im Körper führt, wenn Alkohol aufgenommen wird. Dies führt zu unangenehmen Reaktionen wie Übelkeit, Erbrechen und Kopfschmerzen, wodurch das Risiko einer erneuten Alkoholaufnahme reduziert wird. \n→ Indikation: Alkoholismus \n→ Nebenwirkungen: Kopfschmerzen, Übelkeit, Erbrechen, Schwindel, Herzklopfen, Blutdruckabfall \n→ Kontraindikation: Leber- und Nierenerkrankungen, Allergie gegen den Wirkstoff',
  'Acamprosat?':
      ' \n→ Wirkstoffklasse: GABA-Agonist \n→ Wirkmechanismus: der Wirkstoff wird bei der Behandlung von Alkoholismus eingesetzt. Es wirkt durch Regulierung der GABA-Signalübertragung und Modulation von Glutamatergic Signalen. Dies hilft, das Verlangen nach Alkohol zu reduzieren und unterstützt den Patienten dabei, abstinent zu bleiben. \n→ Indikation: Alkoholismus \n→ Nebenwirkungen: Übelkeit, Durchfall, Bauchschmerzen, Kopfschmerzen, Schlafstörungen \n→ Kontraindikation: Schwangerschaft und Stillzeit, Nierenerkrankungen',
  'Nikotinpflaster?':
      ' \n→ Wirkstoffklasse: Nikotin-Ersatztherapie \n→ Wirkmechanismus: das Arzneimittel ist eine Form der Nikotin-Ersatztherapie, die darauf abzielen, den Entzug von Nikotin zu verringern, indem sie das Nikotin durch ein Pflaster auf die Haut langsam freisetzen. Das Nikotin wird aufgenommen und an das Gehirn weitergeleitet, wo es eine ähnliche Wirkung hat wie das Nikotin aus Zigaretten. \n→ Indikation: Raucherentwöhnung \n→ Nebenwirkungen: Juckreiz, Hautreizungen, Kopfschmerzen, Übelkeit, Schwindel \n→ Kontraindikation: Überempfindlichkeit gegen Nikotin oder einen der Bestandteile des Pflasters, Herz-Kreislauf-Erkrankungen, fortgeschrittene arterielle Durchblutungsstörungen.',
  'Bupropion?':
      ' \n→ Wirkstoffklasse: Antidepressivum und Antidepressivum-ähnlicher Substanz \n→ Wirkmechanismus: das Arzneimittel wirkt durch Hemmung der Wiederaufnahme von Dopamin und Noradrenalin im Gehirn, was zu einer Erhöhung ihrer Konzentration führt. Dies wiederum verbessert die Stimmung und reduziert das Verlangen nach Nikotin. \n→ Indikation: Behandlung von Depressionen und Nikotinentzug \n→ Nebenwirkungen: Übelkeit, Kopfschmerzen, Schlaflosigkeit, nervöse Unruhe, Verdauungsstörungen \n→ Kontraindikation: Geschichte von Schlaganfall oder koronarer Herzkrankheit, Alkohol- oder Drogenabhängigkeit',
  'Vareniclin?':
      ' \n→ Wirkstoffklasse: Pflanzlicher Alkaloid, Nikotinersatztherapie \n→ Wirkmechanismus: der Wirkstoff wirkt durch Bindung an die Nikotinrezeptoren im Gehirn und liefert somit eine ähnliche Stimulation wie Nikotin, was das Verlangen nach Nikotin reduziert. \n→ Indikation: Behandlung des Nikotinentzugs \n→ Nebenwirkungen: Übelkeit, Schlafstörungen, Kopfschmerzen, Mundtrockenheit, Durchfall \n→ Kontraindikation: Allergie gegen den Wirkstoff oder einen seiner Inhaltsstoffe, akute Psychose oder Depression.'
};

Map<String, String> tuberculose = {
  'Isoniazid?':
      ' \n→ Wirkstoffklasse: Antituberkulose \n→ Wirkmechanismus: Isoniazid wird als Antituberkulose-Medikament verwendet und wirkt, indem es die Bildung von Mycolic Säuren hemmt, welche ein wichtiger Bestandteil der Zellwand von Mycobacterium tuberculosis (dem Erreger der Tuberkulose) sind. Dies führt zur Unterbrechung der Zellwand-Synthese und somit zum Absterben des Bakteriums. \n→ Indikation: Tuberkulose \n→ Nebenwirkungen: Übelkeit, Erbrechen, Durchfall, Kopfschmerzen, Schläfrigkeit, nervöse Störungen, Hautausschläge, Gelenkschmerzen \n→ Kontraindikation: Leberschäden, allergische Reaktionen auf Isoniazid oder andere Tuberkulose-Medikamente',
  'Rifampicin?':
      ' \n→ Wirkstoffklasse: Antituberkulose \n→ Wirkmechanismus: Rifampicin ist ein Antituberkulose-Medikament, das die Synthese von RNA in Mycobacterium tuberculosis hemmt, dem Erreger der Tuberkulose. Dies führt zur Unterbrechung der Zellteilung und somit zum Absterben des Bakteriums. \n→ Indikation: Tuberkulose \n→ Nebenwirkungen: Übelkeit, Erbrechen, Durchfall, Gelbsucht, Leberschäden, Hautausschläge, Kopfschmerzen \n→ Kontraindikation: Leberschäden, allergische Reaktionen auf Rifampicin oder andere Tuberkulose-Medikamente, Schwangerschaft und Stillzeit',
  'Pyrazinamid?':
      ' \n→ Wirkstoffklasse: Antituberkulose \n→ Wirkmechanismus: Pyrazinamid ist ein Antituberkulose-Medikament, das die Bildung von Zellwand- und Zellmembranbestandteilen in Mycobacterium tuberculosis hemmt, dem Erreger der Tuberkulose. Dies führt zur Unterbrechung der Zellteilung und somit zum Absterben des Bakteriums. \n→ Indikation: Tuberkulose \n→ Nebenwirkungen: Übelkeit, Erbrechen, Durchfall, Kopfschmerzen, Gelenkschmerzen, Muskelschmerzen, Gelbsucht \n→ Kontraindikation: Leberschäden, allergische Reaktionen auf Pyrazinamid oder andere Tuberkulose-Medikamente, Schwangerschaft und Stillzeit.',
  'Ethambutol?':
      ' \n→ Wirkstoffklasse: Antituberkulose-Medikament \n→ Wirkmechanismus: Ethambutol wirkt, indem es die Bildung von Zellwänden bei Mycobacterium tuberculosis hemmt, dem Erreger der Tuberkulose. Dies führt zur Störung der Zellwandbildung und zur Verhinderung des Wachstums und Überlebens der Bakterien. \n→ Indikation: Tuberkulose \n→ Nebenwirkungen: Sehstörungen, Übelkeit, Kopfschmerzen, Veränderungen der Farbwahrnehmung \n→ Kontraindikation: Überempfindlichkeit gegen den Wirkstoff oder einen der Hilfsstoffe',
  'Moxifloxacin?':
      ' \n→ Wirkstoffklasse: Fluorchinolon \n→ Wirkmechanismus: Moxifloxacin hemmt die bakterielle DNA-Gyrase und Topoisomerase IV, was zur Verhinderung der DNA-Replikation und Überlebensfähigkeit der Bakterien führt. Es wird gegen eine breite Palette an Gram-positiven und Gram-negativen Bakterien eingesetzt, einschließlich Mycobacterium tuberculosis. \n→ Indikation: Tuberkulose, sowie andere bakterielle Infektionen \n→ Nebenwirkungen: Übelkeit, Durchfall, Magenschmerzen, Kopfschmerzen \n→ Kontraindikation: Überempfindlichkeit gegen Fluorchinolone oder einen der Hilfsstoffe, Vorliegen von Neuralgie oder Neuropathie, Nieren- oder Leberfunktionsstörungen.'
};

Map<String, String> rheumaUndGicht = {
  'NSAR (nichtsteroidale Antirheumatika)?':
      ' \n→ Wirkstoffklasse: entzündungshemmende und analgetische Medikamente \n→ Wirkmechanismus: NSAR reduzieren Entzündungen durch Hemmung der Produktion von Prostaglandinen. Prostaglandine sind biologisch aktive Substanzen, die an der Regulation von Schmerzen, Fieber und Entzündung beteiligt sind. Die Hemmung von COX-1 und COX-2, den beiden Formen des Enzyms Cyclooxygenase, verhindert die Synthese von Prostaglandinen. \n→ Indikation: Rheumatoide Arthritis, osteoartikuläre Schmerzen, postoperativer Schmerz, Migräne \n→ Nebenwirkungen: Magen-Darm-Beschwerden, Übelkeit, Durchfall, Kopfschmerzen, Schläfrigkeit, Schwindel \n→ Kontraindikation: Magen-Darm-Erkrankungen, Nieren- und Leberfunktionsstörungen, allergische Reaktionen auf NSAR',
  'DMARD (disease-modifying antirheumatic drugs)?':
      ' \n→ Wirkstoffklasse: immunmodulierende Medikamente \n→ Wirkmechanismus: DMARDs wirken, indem sie das Immunsystem beeinflussen, um die Gelenksentzündung bei rheumatischen Erkrankungen zu reduzieren und somit Schäden an den Gelenken zu verhindern. Diese Medikamente beeinflussen entweder das komplexe Zusammenspiel von Zellen und Signalstoffen, die für die Entzündungsreaktion verantwortlich sind, oder hemmen direkt Entzündungsmediatoren. \n→ Indikation: Rheumatoide Arthritis, juvenile idiopathische Arthritis, Psoriasis-Arthritis \n→ Nebenwirkungen: Übelkeit, Durchfall, Kopfschmerzen, Schläfrigkeit, Blutbildveränderungen, Leberfunktionsstörungen \n→ Kontraindikation: Autoimmunerkrankungen, Infektionen, schwere Leber- oder Nierenfunktionsstörungen',
  'DCARD (Disease-modifying antirheumatic drugs)?':
      ' \n→ Wirkstoffklasse: Synthetische Basismedikamente \n→ Wirkmechanismus: DCARDs sind synthetische Basismedikamente, die das Fortschreiten der rheumatoiden Arthritis (RA) verlangsamen und die Entzündung reduzieren können. Sie beeinflussen das Immunsystem, um die Entzündung zu reduzieren und das Gelenkschaden zu verlangsamen. Einige DCARDs hemmen die Entwicklung von Zellen, die für Entzündungen verantwortlich sind, während andere das Wachstum von neuen Blutgefäßen, die zur Entzündung beitragen, unterdrücken. \n→ Indikation: rheumatoide Arthritis \n→ Nebenwirkungen: Übelkeit, Durchfall, Kopfschmerzen, Benommenheit, Leber- und Nierenschäden, Anämie \n→ Kontraindikation: Lebererkrankungen, Blutstörungen, Infektionen',
  'tsDMARDs (targeted synthetic disease-modifying antirheumatic drugs)?':
      ' \n→ Wirkstoffklasse: Synthetische Basismedikamente \n→ Wirkmechanismus: tsDMARDs sind eine neue Klasse von synthetischen Basismedikamenten, die speziell gegen bestimmte molekulare Ziele gerichtet sind, die für die rheumatoide Arthritis (RA) verantwortlich sind. Sie wirken, indem sie einige der körpereigenen Proteine, die für Entzündungen verantwortlich sind, hemmen, und so die Entzündung reduzieren und das Gelenkschaden verlangsamen. \n→ Indikation: rheumatoide Arthritis \n→ Nebenwirkungen: Übelkeit, Durchfall, Kopfschmerzen, Hautausschläge, Leber- und Nierenschäden, Anämie \n→ Kontraindikation: Lebererkrankungen, Blutstörungen, Infektionen',
  'Diclofenac?':
      ' \n→ Wirkstoffklasse: NSAR (Nicht-steroidales Antirheumatikum) \n→ Wirkmechanismus: Diclofenac wirkt als Hemmer der Prostaglandinsynthese, was zu einer Verminderung von Entzündungen und Schmerzen führt. Es ist ein analgetisches und anti-entzündliches Medikament, das häufig zur Behandlung von Gelenk- und Wirbelsäulenerkrankungen wie Osteoarthritis und Rückenschmerzen verwendet wird. \n→ Indikation: Gelenk- und Wirbelsäulenerkrankungen, Schmerzen \n→ Nebenwirkungen: Übelkeit, Durchfall, Magen-Darm-Beschwerden, Kopfschmerzen, Schläfrigkeit \n→ Kontraindikation: Überempfindlichkeit gegen den Wirkstoff, Geschwüre im Magen-Darm-Trakt, Schwangerschaft, Stillzeit',
  'Prednisolon?':
      ' \n→ Wirkstoffklasse: Glukokortikoid \n→ Wirkmechanismus: Prednisolon ist ein synthetisches Glucocorticoid, das eine immunsuppressive und entzündungshemmende Wirkung hat. Es reduziert die Aktivität von entzündlichen Zellen und vermindert dadurch Schmerzen, Schwellungen und Fieber. \n→ Indikation: Autoimmunerkrankungen, allergische Reaktionen, entzündliche Gelenkerkrankungen wie Rheuma \n→ Nebenwirkungen: Gewichtszunahme, Stimmungsschwankungen, verminderte Knochendichte, Abhängigkeit von hohen Dosen, Unterdrückung der eigenen Kortisolproduktion \n→ Kontraindikation: Überempfindlichkeit gegen den Wirkstoff, Infektionen, Osteoporose, Diabetes, Bluthochdruck.',
  'Methotrexat?':
      ' \n→ Wirkstoffklasse: Folsäure-Antagonist (DMARD) \n→ Wirkmechanismus: Methotrexat ist ein Folsäure-Antagonist, der die DNA-Synthese hemmt. Es unterbindet spezifisch dihydrofolatreduktase, ein Enzym, das für die Synthese von Folat erforderlich ist, einem essentiellen Bestandteil für die DNA-Synthese. Dies führt zur Hemmung der Zellteilung und zur Induktion von Apoptose. \n→ Indikation: Rheumatoide Arthritis, Psoriasis, und andere Autoimmunerkrankungen, gleichzeitig mit Folsäuresubstitution \n→ Nebenwirkungen: Übelkeit, Durchfall, Stomatitis, Leukopenie, Anämie, Müdigkeit \n→ Kontraindikation: Schwangerschaft, Stillzeit, Niereninsuffizienz',
  'Leflunomid?':
      '\n→ Wirkstoffklasse: pyrimidinbasierte DMARDs \n→ Wirkmechanismus: Leflunomid ist ein pyrimidinbasiertes DMARD, das den Zellstoffwechsel und die Proliferation von lymphozytären Zellen beeinflusst. Es hemmt spezifisch die De-novo-Synthese von Purinen, was zu einer Verringerung der Zellteilung und Induktion von Apoptose führt. \n→ Indikation: Rheumatoide Arthritis \n→ Nebenwirkungen: Durchfall, Übelkeit, Leberfunktionsstörung, Hypertonie, Hautausschlag \n→ Kontraindikation: Schwangerschaft, Stillzeit, Leberinsuffizienz',
  'Sulfasalazin?':
      ' \n→ Wirkstoffklasse: Sulfonamid-Derivat (DMARD) \n→ Wirkmechanismus: Sulfasalazin ist ein Sulfonamid-Derivat, das die Entzündung unterdrückt, indem es eine spezifische Form von Enzymen (Cyclooxygenase) hemmt, die an der Synthese von Prostaglandinen beteiligt sind. Prostaglandine spielen eine wichtige Rolle bei der Regulierung der Entzündungsreaktionen im Körper. \n→ Indikation: Rheumatoide Arthritis \n→ Nebenwirkungen: Übelkeit, Durchfall, Bauchschmerzen, Kopfschmerzen, allergische Reaktionen, Hautausschläge, Durchblutungsstörungen \n→ Kontraindikation: Überempfindlichkeit gegenüber Sulfonamiden, Blutbildveränderungen, Nieren- oder Leberfunktionsstörungen',
  'Chloroquin/Hydrochloroquin?':
      ' \n→ Wirkstoffklasse: Antimalariamittel (DMARD) \n→ Wirkmechanismus: Chloroquin und Hydrochloroquin wirken als Antimalariamittel, indem sie den Stoffwechsel von bestimmten Parasiten stören und ihre Vermehrung verlangsamen. Darüber hinaus können sie auch entzündungshemmende Wirkungen haben, die bei der Behandlung von Autoimmunerkrankungen wie rheumatoider Arthritis von Nutzen sein können. \n→ Indikation: Malaria, Rheumatoide Arthritis \n→ Nebenwirkungen: Übelkeit, Durchfall, Kopfschmerzen, Schwindel, Augen- oder Hörstörungen, allergische Reaktionen, Leber- oder Nierenfunktionsstörungen \n→ Kontraindikation: Überempfindlichkeit gegenüber Chloroquin oder Hydrochloroquin, retinaler Degeneration, Herzrhythmusstörungen, Nieren- oder Leberfunktionsstörungene',
  'Adalimumab?':
      ' \n→ Wirkstoffklasse: TNF-α-Antikörper \n→ Wirkmechanismus: Adalimumab ist ein humaner monoklonaler Antikörper, der spezifisch gegen das Zytokin Tumornekrosefaktor-α (TNF-α) gerichtet ist. TNF-α spielt eine wichtige Rolle in der Entzündung und ist bei rheumatischen Erkrankungen wie Rheumatoider Arthritis, ankylosierender Spondylitis und Psoriasis-Arthritis erhöht aktiv. Adalimumab bindet an TNF-α und verhindert so dessen Wirkung. \n→ Indikation: Rheumatoide Arthritis, ankylosierende Spondylitis, Psoriasis-Arthritis, Colitis ulcerosa, Morbus Crohn \n→ Nebenwirkungen: Übelkeit, Durchfall, Kopfschmerzen, Schwindel, Juckreiz, Hautausschläge, Infektionen \n→ Kontraindikation: Überempfindlichkeit gegen Adalimumab oder einen seiner Bestandteile, aktive Tuberkulose, schwere Infektionen',
  'Etanercept?':
      ' \n→ Wirkstoffklasse: TNF-α-Rezeptor-Fusionprotein \n→ Wirkmechanismus: Etanercept ist ein rekombinantes Fusionsprotein, das die Wirkung von TNF-α blockiert, indem es an den TNF-α-Rezeptor bindet und ihn neutralisiert. Dies verhindert die Übertragung von entzündungsfördernden Signalen, die durch TNF-α ausgelöst werden. \n→ Indikation: Rheumatoide Arthritis, ankylosierende Spondylitis, Psoriasis-Arthritis, Colitis ulcerosa, Morbus Crohn \n→ Nebenwirkungen: Übelkeit, Durchfall, Kopfschmerzen, Schwindel, Juckreiz, Hautausschläge, Infektionen \n→ Kontraindikation: Überempfindlichkeit gegen Etanercept oder einen seiner Bestandteile, aktive Tuberkulose, schwere Infektionen',
  'Infliximab?':
      ' \n→ Wirkstoffklasse: Tumornekrosefaktor-alpha-(TNFα)-Antagonist \n→ Wirkmechanismus: Infliximab ist ein monoklonaler Antikörper, der an den Tumornekrosefaktor-alpha (TNFα) bindet und dessen Funktion blockiert. TNFα ist ein entzündungsförderndes Cytokin, das bei rheumatischen Erkrankungen übermäßig produziert wird. Die Hemmung von TNFα durch Infliximab führt zur Reduktion der Entzündung und Schmerz bei Patienten mit rheumatischen Erkrankungen wie rheumatoider Arthritis, Morbus Bechterew und Psoriasis-Arthritis. \n→ Indikation: rheumatoide Arthritis, Morbus Bechterew, Psoriasis-Arthritis \n→ Nebenwirkungen: Infektionen, Übelkeit, Durchfall, Kopfschmerzen, Schwindel \n→ Kontraindikation: Überempfindlichkeit gegenüber Infliximab oder einem seiner Bestandteile, aktive Tuberkulose',
  'Golimumab?':
      ' \n→ Wirkstoffklasse: Tumornekrosefaktor-alpha-(TNFα)-Antagonist \n→ Wirkmechanismus: Golimumab ist ein monoklonaler Antikörper, der an den Tumornekrosefaktor-alpha (TNFα) bindet und dessen Funktion blockiert. TNFα ist ein entzündungsförderndes Cytokin, das bei rheumatischen Erkrankungen übermäßig produziert wird. Die Hemmung von TNFα durch Golimumab führt zur Reduktion der Entzündung und Schmerz bei Patienten mit rheumatischen Erkrankungen wie rheumatoider Arthritis, Psoriasis-Arthritis, ankylosierender Spondylitis und colitis ulcerosa. \n→ Indikation: rheumatoide Arthritis, Psoriasis-Arthritis, ankylosierende Spondylitis, colitis ulcerosa \n→ Nebenwirkungen: Infektionen, Übelkeit, Durchfall, Kopfschmerzen, Schwindel \n→ Kontraindikation: Überempfindlichkeit gegenüber Golimumab oder einem seiner Bestandteile, aktive Tuberkulose',
  'Rituximab?':
      ' \n→ Wirkstoffklasse: monoklonaler Antikörper \n→ Wirkmechanismus: Rituximab ist ein monoklonaler Antikörper, der sich an die CD20-Oberflächenantigene auf B-Zellen bindet und deren Abbau fördert. Dies führt zur Reduktion der Anzahl von B-Zellen, die für die Entstehung und den Verlauf vieler autoimmune Erkrankungen, einschließlich rheumatoider Arthritis, verantwortlich sind. \n→ Indikation: rheumatoide Arthritis, chronische lymphatische Leukämie \n→ Nebenwirkungen: Übelkeit, Durchfall, Fieber, Hautausschläge, Müdigkeit, Anämie \n→ Kontraindikation: Schwangerschaft und Stillzeit, schwere Überempfindlichkeitsreaktionen auf vorherige Dosen',
  'Abatacept?':
      ' \n→ Wirkstoffklasse: T-Zell-Kostimulator \n→ Wirkmechanismus: Abatacept blockiert das Co-Stimulationssignal, das für die Aktivierung von T-Zellen notwendig ist. Dies unterdrückt die Aktivität von T-Zellen, die an autoimmune Prozesse beteiligt sind, wie beispielsweise rheumatoide Arthritis. \n→ Indikation: rheumatoide Arthritis, juveniler idiopathischer Arthritis \n→ Nebenwirkungen: Übelkeit, Durchfall, Hautausschläge, Fieber, Infektionen \n→ Kontraindikation: Schwangerschaft und Stillzeit, schwere Überempfindlichkeitsreaktionen auf vorherige Dosen',
  'Tocilizumab?':
      ' \n→ Wirkstoffklasse: Interleukin-6-Rezeptor-Antagonist \n→ Wirkmechanismus: Tocilizumab blockiert den Interleukin-6-Rezeptor, ein Zytokin, das für die Regulation von Entzündungsreaktionen verantwortlich ist. Dies unterdrückt die Entzündungsreaktionen, die bei rheumatischen Erkrankungen wie rheumatoider Arthritis und systemischem Lupus erythematodes vorliegen. \n→ Indikation: rheumatoide Arthritis, systemischer Lupus erythematodes, kryoglobulinämische Vaskulitis \n→ Nebenwirkungen: Übelkeit, Durchfall, Hautausschläge, Infektionen, hoher Blutdruck \n→ Kontraindikation: Schwangerschaft und Stillzeit, Infektionen, aktive Tuberkulose.',
  'Azathioprin?':
      ' \n→ Wirkstoffklasse: immunsuppressive Medikament \n→ Wirkmechanismus: der Wirkstoff unterdrückt das Immunsystem, indem es die Bildung von Zellen in der Knochenmarksstammzelle hemmt. Dadurch wird die Aktivität des körpereigenen Abwehrsystems verringert. \n→ Indikation: behandeln autoimmune Erkrankungen, wie rheumatoide Arthritis oder Morbus Crohn \n→ Nebenwirkungen: Übelkeit, Durchfall, Erhöhung der Infektionsanfälligkeit, Leukopenie, Anämie, Haarausfall \n→ Kontraindikation: Schwangerschaft und Stillzeit, bei erhöhter Anfälligkeit für Infektionen',
  'Cyclophosphamid?':
      ' \n→ Wirkstoffklasse: immunsuppressives und zytostatisches Medikament \n→ Wirkmechanismus: der Wirkstoff unterdrückt das Immunsystem und beeinflusst die DNA-Synthese. Dadurch wird die Vermehrung von Zellen gehemmt, wodurch es bei bestimmten Krebserkrankungen wirksam ist und das Abwehrsystem unterdrückt wird. \n→ Indikation: behandeln autoimmune Erkrankungen, wie rheumatoide Arthritis oder multiple Sklerose, und bestimmte Krebserkrankungen \n→ Nebenwirkungen: Übelkeit, Durchfall, Erhöhung der Infektionsanfälligkeit, Leukopenie, Anämie, Menstruationsstörungen \n→ Kontraindikation: Schwangerschaft und Stillzeit, bei erhöhter Anfälligkeit für Infektionen',
  'Tofacitinib?':
      ' \n→ Wirkstoffklasse: JAK-Inhibitor \n→ Wirkmechanismus: der Wirkstoff blockiert die JAK-Proteine, die an der Übertragung von Signalen im Körper beteiligt sind. Diese Hemmung führt zu einer Reduktion von Entzündungen und Schmerzen bei rheumatoider Arthritis. \n→ Indikation: behandeln der rheumatoiden Arthritis \n→ Nebenwirkungen: Übelkeit, Durchfall, Kopfschmerzen, Schwindel, Hautausschläge, erhöhte Infektionsanfälligkeit \n→ Kontraindikation: Schwangerschaft und Stillzeit, bei erhöhter Anfälligkeit für Infektionen',
  'Baracitinib?':
      ' \n→ Wirkstoffklasse: JAK-Inhibitor \n→ Wirkmechanismus: der Wirkstoff ist ein Inhibitor des Janus-Kinase (JAK) Enzyms, das an der Signaltransduktion von Cytokinen beteiligt ist. Diese Hemmung der JAK-Aktivität führt zu einer Hemmung der Entzündung und Schmerzproduktion. \n→ Indikation: Rheumatoide Arthritis \n→ Nebenwirkungen: Infektionen, Übelkeit, Durchfall, Bluthochdruck, Leberfunktionsstörungen, Lippen- und Zungenschwellungen \n→ Kontraindikation: Schwangerschaft und Stillzeit, Überempfindlichkeit gegen den Wirkstoff oder einen Bestandteil des Arzneimittels.',
  'Allopurinol?':
      ' \n→ Wirkstoffklasse: Xanthinoxidase-Inhibitor \n→ Wirkmechanismus: Allopurinol wirkt als Xanthinoxidase-Inhibitor und hemmt dadurch die Umwandlung von Xanthin zu Urik acid. Dies führt zu einer Reduktion der Harnsäurekonzentration im Blut und ist besonders bei Patienten mit Gicht angezeigt. \n→ Indikation: Gicht, Hyperurikämie \n→ Nebenwirkungen: Hautausschläge, Übelkeit, Durchfall, Leberfunktionsstörungen \n→ Kontraindikation: Überempfindlichkeit gegen Allopurinol oder seine Bestandteile?',
  'Probenecid?':
      ' \n→ Wirkstoffklasse: der Wirkstoff ist ein sogenanntes Urikosurikum \n→ Wirkmechanismus: Probenecid blockiert die Rückresorption von Harnsäure im Nierenbecken und erhöht dadurch den Abfluss von Harnsäure aus dem Körper. Dies wird genutzt, um die Harnsäurekonzentration zu senken und dadurch Gichtanfälle zu verhindern. \n→ Indikation: Gicht, Hyperurikämie \n→ Nebenwirkungen: Kopfschmerzen, Übelkeit, Durchfall, Nierenfunktionsstörungen \n→ Kontraindikation: Niereninsuffizienz, Schwangerschaft, Stillzeit.',
  'Colchicin?':
      ' \n→ Wirkstoffklasse: Antigout-Medikament \n→ Wirkmechanismus: der Wirkstoff ist ein Alkaloid, das eine entzündungshemmende Wirkung aufweist. Es verlangsamt die Migration von Leukozyten und hemmt die Freisetzung von Entzündungsmediatoren. Dadurch wird die Schmerz- und Entzündungsreaktion bei Gicht reduziert. \n→ Indikation: Akute Gichtanfälle \n→ Nebenwirkungen: Durchfall, Übelkeit, Bauchschmerzen, Erbrechen, Leberschäden, allergische Reaktionen \n→ Kontraindikation: Magen-Darm-Blutungen, Nieren- oder Lebererkrankungen',
  'Naproxen?':
      ' \n→ Wirkstoffklasse: Non-steroidales Antiphlogistikum (NSAID) \n→ Wirkmechanismus: der Wirkstoff wirkt durch Hemmung der Cyclooxygenase-Enzyme, die für die Synthese von Prostaglandinen verantwortlich sind. Prostaglandine spielen eine wichtige Rolle bei der Regulation von Schmerzen, Fieber und Entzündungen. Durch die Hemmung von Cyclooxygenase wird die Produktion von Prostaglandinen reduziert und somit Schmerzen, Fieber und Entzündungen gelindert. \n→ Indikation: Schmerzen und Entzündungen bei Arthritis, Gicht \n→ Nebenwirkungen: Magen-Darm-Blutungen, Durchfall, Übelkeit, Kopfschmerzen, allergische Reaktionen, Nieren- oder Leberschäden \n→ Kontraindikation: Magen-Darm-Blutungen, Nieren- oder Lebererkrankungen, schwangere Frauen oder Frauen in der Stillzeit.',
  'Canakinumab?':
      ' \n→ Wirkstoffklasse: monoklonaler Antikörper \n→ Wirkmechanismus: der Wirkstoff ist ein monoklonaler Antikörper, der an Interleukin-1β bindet und damit die Entzündungsreaktion hemmt. Es wird angenommen, dass es den Knochenstoffwechsel und das Fortschreiten von Gichtanfällen hemmt. \n→ Indikation: chronische Gichtarthritis \n→ Nebenwirkungen: Infektionen, Überempfindlichkeitsreaktionen, Bluthochdruck, Magen-Darm-Beschwerden \n→ Kontraindikation: bekannte Überempfindlichkeit gegen Canakinumab oder einen seiner Bestandteile'
};

Map<String, String> virostatika = {
  'Oseltamivir?':
      ' \n→ Wirkstoffklasse: Neuraminidase-Inhibitor \n→ Wirkmechanismus: Oseltamivir hemmt die Neuraminidase-Enzyme von Influenza-Viren, was zur Verhinderung der Vermehrung und Ausbreitung der Viren im Körper führt. Dies reduziert die Schwere und Dauer der Symptome einer Influenza-Infektion. Verkürzt die Erkrankungsdauer um etwa einen Tag \n→ Indikation: Influenza-Infektionen \n→ Nebenwirkungen: Übelkeit, Kopfschmerzen, Durchfall, Bauchschmerzen, Schlaflosigkeit \n→ Kontraindikation: Überempfindlichkeit gegen Oseltamivir oder einen seiner Bestandteile',
  'Amantadin?':
      ' \n→ Wirkstoffklasse: Antiviraler Wirkstoff \n→ Wirkmechanismus: das Medikament wirkt durch Hemmung des Virus-Replikationsprozesses bei Influenza-A-Viren. Es bindet an die Virushülle und verhindert so die Freisetzung des viralen Erbguts, was zu einer Verlangsamung der Vermehrung und Ausbreitung der Viren im Körper führt. Über Blockade des M2 Proteins \n→ Indikation: Influenza-A-Infektionen (wird nicht mehr verwendet) \n→ Nebenwirkungen: Schläfrigkeit, Kopfschmerzen, Übelkeit, Schwindel, Verwirrtheit, Sehstörungen \n→ Kontraindikation: Überempfindlichkeit gegen Amantadin oder einen seiner Bestandteile, schwerwiegende Leber- oder Nierenfunktionsstörungen',
  'Remdesivir?':
      ' \n→ Wirkstoffklasse: antivirales Mittel \n→ Wirkmechanismus: der Wirkstoff ist ein RNA-Polymerase-Inhibitor, der das Replikationsvermögen von RNA-Viren, wie dem SARS-CoV-2-Virus, hemmt. Es bindet an die RNA-Polymerase des Virus und hindert somit dessen Fähigkeit, neue virale RNA-Stränge zu bilden und sich zu vermehren. \n→ Indikation: COVID-19-Erkrankung \n→ Nebenwirkungen: Übelkeit, Kopfschmerzen, Fatigue, Schmerzen an der Injektionsstelle \n→ Kontraindikation: Überempfindlichkeit gegen den Wirkstoff oder einen seiner Bestandteile',
  'Molnupiravir?':
      ' \n→ Wirkstoffklasse: antivirales Mittel \n→ Wirkmechanismus: der Arzneistoff ist ein Mittel zur Hemmung der Replikation von RNA-Viren, einschließlich SARS-CoV-2. Es hemmt die virale Polymerase und hindert somit das Virus daran, sich zu vermehren und zu replizieren. \n→ Indikation: COVID-19-Erkrankung \n→ Nebenwirkungen: Übelkeit, Erbrechen, Durchfall, Kopfschmerzen \n→ Kontraindikation: Überempfindlichkeit gegen den Wirkstoff oder einen seiner Bestandteile',
  'Nirmatrelvir/Ritonavir?':
      ' \n→ Wirkstoffklasse: antivirales Mittel \n→ Wirkmechanismus: das Medikament ist ein Protease-Inhibitor, der in Kombination mit Ritonavir verwendet wird. Die Kombination wirkt durch Hemmung der virale Protease, einem wichtigen Enzym, das für die Replikation und Vermehrung von RNA-Viren, einschließlich SARS-CoV-2, erforderlich ist. \n→ Indikation: COVID-19-Erkrankung \n→ Nebenwirkungen: Übelkeit, Durchfall, Kopfschmerzen, Schwindel, Müdigkeit \n→ Kontraindikation: Überempfindlichkeit gegen den Wirkstoff oder einen seiner Bestandteile, Leberfunktionsstörungen oder medikamenteninduzierte Leberschäden.',
  'Dexamethason?':
      ' \n→ Wirkstoffklasse: Corticosteroid \n→ Wirkmechanismus: der Wirkstoff ist ein synthetisches Corticosteroid, das entzündungshemmende und immunsuppressive Eigenschaften hat. Es wirkt, indem es die Aktivität von bestimmten weißen Blutkörperchen und die Freisetzung bestimmter Entzündungsmediatoren hemmt. \n→ Indikation: akute respiratorische distress-Syndrom (ARDS) bei COVID-19-Patienten \n→ Nebenwirkungen: Übermäßige Blähungen, Durchfall, Magenverstimmungen, allergische Reaktionen, Schlafstörungen, verminderte Knochendichte \n→ Kontraindikation: bestehende Infektionen, aktive Tuberkulose, peptic ulcer disease, Osteoporose oder Prädisposition zur Osteoporose, Vorsichtsmaßnahme bei Leber- oder Nierenerkrankungen.',
};
